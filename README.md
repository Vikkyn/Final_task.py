...
- Для работы был выбран Петроградский район Санкт-Петербурга
- Общее количество объектов культурного наследия, расположенных в указанном районе, равно 749.  
- Улица с самым большим количеством объектом культурного наследия, на ней расположенных, - Каменноостровский проспект.   
- Количество объектов на этой улице - 52.
